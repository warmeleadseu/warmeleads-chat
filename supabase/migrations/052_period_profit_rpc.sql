-- Returns revenue, ad spend and profit for each dashboard period.
-- Revenue = batch assignment revenue + bulk assignment revenue within the date range.
-- Ad spend = meta_ad_spend within the date range (filtered to relevant campaigns).
