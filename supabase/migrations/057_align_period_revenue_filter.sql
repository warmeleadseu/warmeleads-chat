-- Align period_profit_stats() revenue filter with live_revenue_stats():
-- Add cb.status IN ('active', 'completed') to batch revenue queries
-- so hero KPI and period cards use identical logic.
