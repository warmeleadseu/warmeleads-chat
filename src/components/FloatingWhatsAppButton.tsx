...
export function FloatingWhatsAppButton() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* WhatsApp Icon */}
        <div className="flex items-center justify-center w-16 h-16 relative flex-shrink-0">
          {/* Ping animation */}
          <motion.div
        ...
        <motion.div
          ...
          className="overflow-hidden whitespace-nowrap pl-3 pr-4 font-semibold"
        >
          Chat met ons!
        </motion.div>
      </motion.a>

      {/* Badge - optional unread count */}
      {/* <motion.div
