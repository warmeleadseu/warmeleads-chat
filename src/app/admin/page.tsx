      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {quickActions.map((action) => (
            ...
            >
              <action.icon className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400 group-hover:text-brand-purple transition-colors mb-2 sm:mb-3" />
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-brand-purple transition-colors">
                {action.name}
              </h3>
            </motion.button>
          ))}
