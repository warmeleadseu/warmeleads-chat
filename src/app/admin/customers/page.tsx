            ...
            return (
              <div key={c.id} className="rounded-xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
                ...
                <div className="flex items-center border-t border-slate-100">
                  ...
                  <button onClick={() => setPricingFor(c)} className="flex flex-1 items-center justify-center gap-1.5 py-2.5 text-xs font-medium text-slate-500 transition hover:bg-slate-50 hover:text-amber-600">
