        ...
        <div className="relative z-10 mx-auto max-w-3xl px-5 py-14 md:py-20 lg:px-8">
          ...
          <div className="space-y-2.5 md:space-y-3">
            {[
              ...
              { q: 'Wat als jullie nog niet in mijn branche actief zijn?', a: 'Geen probleem. Voor €1.000 onderzoekskosten ontdekken we de beste strategie en tarieven voor jouw branche. Dit bedrag krijg je volledig terug in leads, dus het kost je uiteindelijk niets extra.' },
