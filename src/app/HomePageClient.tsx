...
WarmeLeads genereert exclusieve, verse leads voor jouw bedrijf.
              ...
              >
                {[
                  ...
                  { value: 'Realtime', label: 'In je portaal', icon: ChartBarIcon },
                ].map((item) => (
                  <div
                    key={item.label}
      ...
      <section className="border-b border-slate-100 bg-white">
        <div className="mx-auto max-w-7xl px-5 py-5 lg:px-8">
          <div className="grid grid-cols-2 gap-2 md:flex md:items-center md:justify-center md:gap-0">
            {[
              { label: 'Exclusieve leads', first: true },
              { label: 'NL & BE dekking' },
              { label: 'Betaal per lead' },
      ...
      <section className="bg-brand-purple">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-px bg-white/10 md:grid-cols-4">
          {[
            { value: 'Exclusief', label: 'Leads alleen voor jou' },
            { value: 'NL & BE', label: 'Landelijke dekking' },
            { value: '<24u', label: 'Eerste levering' },
            { value: 'Realtime', label: 'In je portaal' },
          ].map((item, i) => (
            <FadeOnView
              key={item.label}
              delay={i * 50}
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-14 md:py-20 lg:px-8">
          <div className="grid items-center gap-8 md:grid-cols-[1fr_1.2fr] md:gap-16">
              ...
              <div className="mt-6 space-y-3 md:mt-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[13px] leading-relaxed text-slate-600 md:text-sm">
                    Exclusieve leads uit eigen campagnes, realtime in je portaal, betaal per lead.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <ShieldCheckIcon className="mt-0.5 h-5 w-5 shrink-0 text-brand-purple" />
                  <p className="text-[13px] leading-relaxed text-slate-600 md:text-sm">
                    Automatische quality checks en een vaste accountmanager die met je meedenkt.
                  </p>
                </div>
              </div>
            </FadeOnView>
            ...
            <FadeOnView className="space-y-4" delay={100}>
              ...
              {[
                {
                  quote: 'Een stabiele instroom van leads uit één regio, zodat het salesteam vooruit kan plannen.',
                  role: 'Installatiebedrijf · zonne-energie',
                },
                {
                  quote: 'Focus op conversie in plaats van losse aantallen: kwalitatieve leads die bij het werkgebied passen.',
                  role: 'Installatiebedrijf · klimaat & warmte',
                },
              ].map((item) => (
                <div
                  key={item.role}
            ...
            <FadeOnView className="group/card relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-[box-shadow,border-color] hover:border-slate-300 hover:shadow-md md:p-8" delay={80}>
              ...
              <div className="relative mt-5 flex items-start gap-3 rounded-xl border border-brand-orange/15 bg-brand-orange/[0.05] p-3 md:mt-6 md:p-4">
                ...
                <p className="text-[12px] leading-relaxed text-slate-700 md:text-[13px]">
                  ...
                  De €1.000 verdien je volledig terug in leads. Het kost je uiteindelijk niets extra.
                </p>
              </div>
