...
export const metadata: Metadata = {
  ...
  description:
    'Meer klanten nodig voor uw installatiebedrijf? Krijg verse, exclusieve leads voor thuisbatterijen, zonnepanelen, warmtepompen en airco\'s. Plan een gratis strategiegesprek.',
  keywords:
