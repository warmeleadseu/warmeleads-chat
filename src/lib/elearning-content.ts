...
export const MODULES: Module[] = [
  // ───────────────────── MODULE 1 ─────────────────────
  {
    ...
    lessons: [
      {
        ...
        sections: [
          { type: 'text', title: 'Wie is WarmeLeads?', body: 'WarmeLeads is dé specialist in leadgeneratie voor de verduurzamingsbranche in Nederland en België. We helpen installateurs en bedrijven in de energietransitie aan een constante stroom van kwalitatieve, exclusieve leads — zonder dat zij zelf hoeven te adverteren.\n\nOnze missie is simpel: **elke installateur verdient een volle agenda**. Wij zorgen voor de aanvragen, zij zorgen voor de installatie.' },
          { type: 'text', title: 'Het probleem dat we oplossen', body: 'Veel installateurs zijn vakspecialisten maar geen marketeers. Ze besteden duizenden euro\'s per maand aan Google Ads of social media zonder te weten of het werkt. Of ze kopen goedkope leadlijsten die koud, verouderd of niet exclusief zijn.\n\nWarmeLeads biedt een alternatief: **resultaatgericht, betaalbaar en transparant**. Onze klanten betalen per lead, niet per klik. Geen abonnement, geen lock-in, geen verrassingen.' },
          { type: 'text', title: 'Onze visie', body: 'We geloven dat de energietransitie sneller gaat als installateurs zich kunnen focussen op hun vak. Door hen te ontzorgen met een betrouwbare stroom van warme leads, dragen we bij aan een snellere verduurzaming van Nederland en België.\n\nOnze ambitie: **de #1 leadpartner worden voor elke installateur in de Benelux**.' },
          { type: 'keypoints', body: '• WarmeLeads = leadgeneratie specialist voor verduurzaming\n• Missie: elke installateur een volle agenda\n• Pay-per-lead model: geen abonnement, geen lock-in\n• Focus op exclusiviteit en kwaliteit\n• Actief in Nederland en België' },
        ],
      },
      {
        id: 'kernwaarden-usps',
    ...
    quiz: [
      { id: 'w1', question: 'Wat is het verdienmodel van WarmeLeads?', options: ['Maandelijks abonnement', 'Betalen per lead/batch', 'Commissie op installaties', 'Gratis met premium opties'], correctIndex: 1, explanation: 'WarmeLeads werkt met een pay-per-lead model. Klanten betalen per batch leads, zonder vaste maandelijkse kosten of lock-in.' },
  ...
  // ───────────────────── MODULE 2 ─────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          { type: 'text', title: 'Hoofdbranches', body: 'WarmeLeads is actief in de volgende hoofdbranches:\n\n**Zonnepanelen** — Onze grootste branche. Particulieren die zonnepanelen willen laten plaatsen.\n\n**Warmtepompen** — Groeiende markt door gasvrij-ambities. Hybride en volledig elektrische warmtepompen.\n\n**Thuisbatterijen** — Steeds populairder door stijgende energieprijzen en salderingswijzigingen.\n\n**Airconditioning** — Seizoensgebonden maar consistente vraag, met piek in voorjaar/zomer.\n\n**Financial Lease** — Financieringsoplossingen voor verduurzaming (zonnepanelen lease, etc.).\n\n**Isolatie** — Dak, spouw, vloer en glasisolatie.' },
          { type: 'text', title: 'Overige niches en maatwerk', body: 'Naast de hoofdbranches zijn we actief in 25+ niches, waaronder:\n\n• Laadpalen (elektrisch rijden)\n• B2B Energie (zakelijke verduurzaming)\n• Dakkapellen\n• Kozijnen & glas\n• Veranda\'s en overkappingen\n• En meer...\n\nVoor branches waar we nog niet actief in zijn, bieden we een **nicheonderzoek** aan voor €750. Dit bedrag wordt volledig gecrediteerd in leads als het onderzoek positief is. Doorlooptijd: 2-4 weken.' },
          { type: 'tip', title: 'Cross-selling kans', body: 'Veel installateurs zijn actief in meerdere branches. Een zonnepanelen-installateur biedt vaak ook warmtepompen of thuisbatterijen aan. Vraag altijd naar alle diensten van de klant — elke extra branche is een extra batch.' },
          { type: 'keypoints', body: '• 6 hoofdbranches: zonnepanelen, warmtepompen, thuisbatterijen, airco, financial lease, isolatie\n• 25+ niches beschikbaar\n• Nicheonderzoek voor nieuwe branches: €750, gecrediteerd in leads\n• Cross-selling: klanten zijn vaak in meerdere branches actief' },
        ],
      },
    ],
    quiz: [
    ...
    lessons: [
      {
        ...
        sections: [
          ...
          { type: 'tip', title: 'Gesprekstip', body: 'Gebruik nooit te veel jargon in een klantgesprek. De meeste installateurs zijn praktijkmensen. Gebruik concrete voorbeelden: "Van de 1.000 mensen die uw advertentie zien, klikken er 50 en 10 vullen hun gegevens in. Dat zijn 10 warme leads."' },
  ...
  // ───────────────────── MODULE 5 ─────────────────────
  {
    ...
    quiz: [
      ...
      { id: 'v4', question: 'Hoe weerleg je "het is te duur"?', options: ['Door korting te geven', 'Door de ROI per lead te berekenen', 'Door te zeggen dat het niet duur is', 'Door gratis leads aan te bieden'], correctIndex: 1, explanation: 'Bereken de ROI: als een installatie €8.000 oplevert en 1 op 5 leads converteert, levert elke lead gemiddeld €1.600 op — ver boven de leadprijs.' },
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'text', title: 'Realistische conversiepercentages', body: '**Zonnepanelen:** 15-25% conversie (goed opvolgbeleid)\n**Warmtepompen:** 10-20% conversie\n**Thuisbatterijen:** 10-15% conversie\n**Airconditioning:** 20-30% conversie (hoge urgentie)\n**Isolatie:** 15-25% conversie\n\nDeze percentages zijn indicatief en afhankelijk van:\n• Snelheid van opvolging (binnen 1 uur is ideaal)\n• Kwaliteit van het verkoopgesprek\n• Prijs en aanbod van de installateur\n• Seizoen en marktomstandigheden' },
          { type: 'scenario', title: 'Rekenvoorbeeld voor de klant', body: '"U bestelt 100 zonnepanelen-leads voor €35 per stuk. Investering: €3.500 + BTW. Bij een conversie van 20% levert dat 20 installaties op. Bij een gemiddelde omzet van €8.000 per installatie is dat €160.000 omzet op een investering van €4.235 incl. BTW. Dat is een ROI van bijna 38x."' },
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'tip', title: 'Prijsgesprek tip', body: 'Als een klant de prijs per lead te hoog vindt, draai het om: "Wat zou u zelf betalen voor een klant die een installatie van €10.000 afneemt? Als onze leads 1 op 5 converteren, betaalt u effectief €175 per klant." Dat relativeert de prijs per lead enorm.' },
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'keypoints', body: '• Veel installateurs zijn actief in 2-3+ branches\n• Veelvoorkomende combinaties kennen\n• Altijd vragen naar alle diensten\n• Klein beginnen in nieuwe branche\n• Combineer met seizoensadvies' },
        ],
      },
      {
        id: 'herbestellingen',
