...
export const MODULES: Module[] = [
  ...
  // ───────────────────── MODULE 2 ─────────────────────
  {
    ...
    lessons: [
      {
        ...
        sections: [
          ...
          { type: 'scenario', title: 'Voorbeeld uitleg aan klant', body: '"Stel, iemand in Amsterdam zoekt op Google naar \'zonnepanelen laten plaatsen\'. Ze zien onze advertentie, klikken erop en vullen hun gegevens in. Binnen enkele minuten ontvang je deze aanvraag in je portaal met naam, telefoonnummer, adres en eventuele opmerkingen. Je belt ze op en maakt een afspraak — dat is een warme lead."' },
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'scenario', title: 'Voorbeeld voor klant', body: '"Als je een batch zonnepanelen-leads bestelt met targeting op de regio Amsterdam-Zuid, ontvang je alleen leads van mensen in dat gebied die actief interesse hebben getoond. Deze leads gaan niet naar een andere installateur — ze zijn exclusief voor jou."' },
    ...
    quiz: [
      ...
      { id: 'd3', question: 'Wat kost het als een klant een nieuwe niche wil waar we nog niet actief in zijn?', options: ['Niet mogelijk', '€1.000 nicheonderzoek (gecrediteerd in leads)', '€250 per maand', '€1.500 eenmalig'], correctIndex: 1, explanation: 'We doen een nicheonderzoek voor €1.000 dat volledig wordt gecrediteerd in leads als het onderzoek positief uitvalt.' },
    ...
    lessons: [
      {
        ...
        sections: [
          ...
          { type: 'tip', title: 'Gesprekstip', body: 'Gebruik nooit te veel jargon in een klantgesprek. De meeste ondernemers zijn praktijkmensen. Gebruik concrete voorbeelden: "Van de 1.000 mensen die je advertentie zien, klikken er 50 en 10 vullen hun gegevens in. Dat zijn 10 warme leads."' },
  ...
  // ───────────────────── MODULE 5 ─────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          { type: 'text', title: 'De 8 meest voorkomende bezwaren', body: '**1. "Het is te duur"**\n→ "Laten we de rekening omdraaien. Als een gemiddelde opdracht €8.000 oplevert en 1 op 5 leads converteert, levert elke lead je €1.600 op. Bij een leadprijs van €35 is dat een rendement van 45x."\n\n**2. "Ik wil er eerst over nadenken"**\n→ "Dat begrijp ik. Wat zou je nog willen weten om een beslissing te nemen? Laten we dat nu bespreken."\n\n**3. "Ik heb slechte ervaringen met leadbedrijven"**\n→ "Dat hoor ik vaker. Wat ging er precies mis? Bij ons zijn leads exclusief, gekwalificeerd, en je kunt reclameren als een lead niet klopt."\n\n**4. "We hebben al genoeg werk"**\n→ "Geweldig! Dan is dit het moment om te selecteren op de beste klanten. Met meer leads kun je kiezen voor de meest winstgevende projecten."' },
          { type: 'text', body: '**5. "Ik geloof niet in online leads"**\n→ "Begrijpelijk als je dat nog niet hebt ervaren. Honderden bedrijven in diverse branches werken al met ons. Mag ik een voorbeeld laten zien van hoe het portaal eruitziet?"\n\n**6. "Ik wil eerst een gratis proef"**\n→ "We bieden geen gratis proeven, maar je kunt starten met een kleine batch van 50 leads. Zo houd je het risico klein en zie je direct de kwaliteit."\n\n**7. "Een collega doet het al"**\n→ "Veel bedrijven in dezelfde regio werken met ons — leads zijn exclusief per klant. Maar ik kan kijken of er nog ruimte is in je specifieke postcodegebied."\n\n**8. "Ik moet het overleggen met mijn partner/compagnon"**\n→ "Natuurlijk. Zal ik een samenvatting sturen die je kunt delen? En zullen we volgende week even kort bellen om de vragen te bespreken?"' },
      ...
      },
      {
        ...
        sections: [
          { type: 'text', title: 'Afsluittechnieken', body: '**De directe afsluiting**\n"Zullen we starten met een batch van 100 zonnepanelen-leads voor de regio Amsterdam?"\n\n**De alternatieve afsluiting**\n"Wil je beginnen met 100 of 200 leads?"\n\n**De tijdgebonden afsluiting**\n"Als we deze week starten, draait de campagne maandag al. Dan ontvang je de eerste leads volgende week."\n\n**De samenvatting-afsluiting**\n"Laat me samenvatten: je wilt leads voor zonnepanelen in de regio Utrecht, circa 100 stuks, met targeting op koopwoningen. Zal ik dat voor je klaarzetten?"' },
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'tip', title: 'Praktijktip', body: 'Geef nooit een specifiek dagelijks of wekelijks aantal als belofte. Zeg: "Op basis van vergelijkbare klanten in je regio verwachten we circa X-Y leads per maand." Gebruik altijd een range, geen exact getal.' },
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'scenario', title: 'Rekenvoorbeeld voor de klant', body: '"Je bestelt 100 zonnepanelen-leads voor €35 per stuk. Investering: €3.500 + BTW. Bij een conversie van 20% levert dat 20 opdrachten op. Bij een gemiddelde omzet van €8.000 per opdracht is dat €160.000 omzet op een investering van €4.235 incl. BTW. Dat is een ROI van bijna 38x."' },
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'tip', title: 'Prijsgesprek tip', body: 'Als een klant de prijs per lead te hoog vindt, draai het om: "Wat zou je zelf betalen voor een klant die een opdracht van €10.000 afneemt? Als onze leads 1 op 5 converteren, betaal je effectief €175 per klant." Dat relativeert de prijs per lead enorm.' },
    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          { type: 'text', title: 'Hoe vraag je om referrals?', body: '**Timing:** Vraag na een positief evaluatiegesprek of na een succesvolle verkoop via de leads.\n\n**De vraag:**\n"Het gaat goed met je leads. Ken je toevallig collega-ondernemers in je netwerk die ook meer klanten kunnen gebruiken? Ik help ze graag net zo als jou."\n\n**Netwerken:**\n• Brancheverenigingen en beurzen\n• Lokale ondernemersclubs\n• Branchespecifieke netwerken\n• Leveranciers en toeleveranciers\n\n**Follow-up:**\nAls een klant een naam noemt: bel dezelfde dag nog en noem de naam van de referent. "Pieter van ZonnePro vertelde me dat je ook zonnepanelen installeert..."' },
